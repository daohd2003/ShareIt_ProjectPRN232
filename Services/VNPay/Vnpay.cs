...
namespace Services.Payments.VNPay
{
    public class Vnpay : IVnpay
    {
        ...
        public string GetPaymentUrl(PaymentRequest request)
        {
            ...
            helper.AddRequestData("vnp_IpAddr", "https://52194f16157f.ngrok-free.app/api/payment/Vnpay/IpnAction");
            ...
            helper.AddRequestData("vnp_ReturnUrl", "https://52194f16157f.ngrok-free.app/api/payment/Vnpay/Callback");
